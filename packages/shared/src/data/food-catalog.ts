/**
 * @pakulab/shared — Food catalog data
 *
 * Mexican baby food catalog data for complementary feeding.
...
import type { WarningTag, FoodGroup, ALClassification } from '../types/food.js'
...
const fruits: FoodSeed[] = [
  ...
  },
  {
    ...
    needsValidation: false,
    // Source: docs/Guia de alimentos_Pau Trueba.pdf page 7 — alimentos duros en trozo prohibited <5y
  ...
  },
  {
    ...
    needsValidation: false,
    // Source: docs/Guia de alimentos_Pau Trueba.pdf page 7 — alimentos redondos enteros (pasas) prohibited <5y; must be chopped or pureed
    warningTags: ['CHOKING_HAZARD_UNDER_5Y', 'REQUIRES_PREPARATION'],
  },
  {
    name: 'Kiwi',
  ...
  },
  {
    ...
    needsValidation: false,
    // Source: docs/Guia de alimentos_Pau Trueba.pdf page 7 — alimentos redondos enteros prohibited <5y
    warningTags: ['CHOKING_HAZARD_UNDER_5Y', 'REQUIRES_PREPARATION'],
  },
  {
    name: 'Arándano',
...
const proteins: FoodSeed[] = [
  ...
  },
  {
    ...
    needsValidation: false,
    // NOTE: garbanzo CHOKING_HAZARD deferred per PR-3 seed.ts:862; NOT on PDF page 7 verbatim. Confirm with product/clinical team before tagging.
  },
  {
  ...
  },
  {
    ...
    needsValidation: false,
    // Source: docs/Guia de alimentos_Pau Trueba.pdf page 7 — frutos secos + pasta espesa prohibited <5y
    warningTags: ['CHOKING_HAZARD_UNDER_5Y', 'REQUIRES_PREPARATION'],
  },
  {
  ...
  },
  {
    ...
    needsValidation: true,
    // Source: docs/Guia de alimentos_Pau Trueba.pdf page 7 — frutos secos prohibited <5y
    warningTags: ['CHOKING_HAZARD_UNDER_5Y', 'REQUIRES_PREPARATION'],
  },
  {
...
const cerealsTubers: FoodSeed[] = [
  ...
  },
  {
    ...
    needsValidation: false,
    // Source: docs/Guia de alimentos_Pau Trueba.pdf page 7 — alimentos redondos enteros prohibited <5y; must be ground or pureed
    warningTags: ['CHOKING_HAZARD_UNDER_5Y', 'REQUIRES_PREPARATION'],
  },
  {
    name: 'Arepa de maíz',
