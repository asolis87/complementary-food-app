...
No AGENTS.md / CLAUDE.md / .cursorrules found at project level.
Global AGENTS.md active at: ~/.config/opencode/AGENTS.md

## Notes

- Project is a greenfield POC (no source code yet, only concept doc)
- Stack defined by user description: Vue 3 + Vite PWA / Fastify / BetterAuth / PostgreSQL + Prisma
- Target market: México, solo dev, freemium model
